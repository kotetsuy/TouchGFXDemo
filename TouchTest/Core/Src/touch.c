...
#define T_DO_ON XPT2046_SetDO()
#define T_DO_OFF XPT2046_ResetDO()
#define T_DO XPT2046_ReadDO()
#define T_DIN_ON XPT2046_SetDIN()
#define T_DIN_OFF XPT2046_ResetDIN()
#define T_CLK_ON XPT2046_SetCLK()
#define T_CLK_OFF XPT2046_ResetCLK()
...
static void XPT2046_SetDO(void)
{
	HAL_GPIO_WritePin(T_DO_GPIO_Port, T_DO_Pin, GPIO_PIN_SET);
}

static void XPT2046_ResetDO(void)
{
	HAL_GPIO_WritePin(T_DO_GPIO_Port, T_DO_Pin, GPIO_PIN_RESET);
}

static GPIO_PinState XPT2046_ReadDO(void)
{
	return HAL_GPIO_ReadPin(T_DO_GPIO_Port, T_DO_Pin);
}

static void XPT2046_SetDIN(void)
{
	HAL_GPIO_WritePin(T_DIN_GPIO_Port, T_DIN_Pin, GPIO_PIN_SET);
}

static void XPT2046_ResetDIN(void)
{
	HAL_GPIO_WritePin(T_DIN_GPIO_Port, T_DIN_Pin, GPIO_PIN_RESET);
}

static void XPT2046_SetCLK(void)
{
	HAL_GPIO_WritePin(T_CLK_GPIO_Port, T_CLK_Pin, GPIO_PIN_SET);
}

static void XPT2046_ResetCLK(void)
{
