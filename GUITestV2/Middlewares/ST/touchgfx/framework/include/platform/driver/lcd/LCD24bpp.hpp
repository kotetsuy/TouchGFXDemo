...
public:
    ...
    /**
     * @fn virtual uint16_t* LCD24bpp::copyFrameBufferRegionToMemory(const Rect& visRegion, const Rect& absRegion, const BitmapId bitmapId);
     *
    ...
    /**
     * @fn virtual Bitmap::BitmapFormat LCD24bpp::framebufferFormat() const
     *
    ...
    /**
     * @fn virtual uint16_t LCD24bpp::framebufferStride() const
     *
    ...
    /**
     * @fn FORCE_INLINE_FUNCTION static uint16_t LCD24bpp::getFramebufferStride()
     *
     * @brief Framebuffer stride in bytes
     *
     *        Framebuffer stride in bytes. The distance (in bytes) from the start of one
    ...
    /**
     * @fn virtual colortype LCD24bpp::getColorFrom24BitRGB(uint8_t red, uint8_t green, uint8_t blue) const
     *
    ...
    /**
     * @fn FORCE_INLINE_FUNCTION static colortype LCD24bpp::getColorFromRGB(uint8_t red, uint8_t green, uint8_t blue)
     *
    ...
    /**
     * @fn virtual uint8_t LCD24bpp::getRedColor(colortype color) const
     *
    ...
    /**
     * @fn FORCE_INLINE_FUNCTION static uint8_t LCD24bpp::getRedFromColor(colortype color)
     *
    ...
    {
        return color.getColor32() >> 16;
    }

    /**
     * @fn virtual uint8_t LCD24bpp::getGreenColor(colortype color) const
     *
    ...
    /**
     * @fn FORCE_INLINE_FUNCTION static uint8_t LCD24bpp::getGreenFromColor(colortype color)
     *
    ...
    {
        return color.getColor32() >> 8;
    }

    /**
     * @fn virtual uint8_t LCD24bpp::getBlueColor(colortype color) const
     *
    ...
    /**
     * @fn FORCE_INLINE_FUNCTION static uint8_t LCD24bpp::getBlueFromColor(colortype color)
     *
    ...
    {
        return color.getColor32();
    }

    /**
     * @fn void LCD24bpp::enableTextureMapperAll();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperL8_RGB888();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperL8_RGB888_BilinearInterpolation();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperL8_RGB888_NearestNeighbor();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperL8_ARGB8888();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperL8_ARGB8888_BilinearInterpolation();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperL8_ARGB8888_NearestNeighbor();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperRGB888();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperRGB888_BilinearInterpolation();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperRGB888_NearestNeighbor();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperARGB8888();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperARGB8888_BilinearInterpolation();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperARGB8888_NearestNeighbor();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperA4();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperA4_BilinearInterpolation();
     *
    ...
    /**
     * @fn void LCD24bpp::enableTextureMapperA4_NearestNeighbor();
     *
...
protected:
    ...
    /**
     * @fn static int LCD24bpp::nextPixel(bool rotatedDisplay, TextRotation textRotation);
     *
    ...
    /**
     * @fn static int LCD24bpp::nextLine(bool rotatedDisplay, TextRotation textRotation);
     *
    ...
    /**
     * @fn virtual void LCD24bpp::drawGlyph(uint16_t* wbuf16, Rect widgetArea, int16_t x, int16_t y, uint16_t offsetX, uint16_t offsetY, const Rect& invalidatedArea, const GlyphNode* glyph, const uint8_t* glyphData, uint8_t dataFormatA4, colortype color, uint8_t bitsPerPixel, uint8_t alpha, TextRotation rotation);
     *
    ...
    /**
     * @fn static void LCD24bpp::blitCopyL8(const uint8_t* sourceData, const uint8_t* clutData, const Rect& source, const Rect& blitRect, uint8_t alpha);
     *
    ...
    /**
     * @fn static void LCD24bpp::blitCopyL8_ARGB8888(const uint8_t* sourceData, const uint8_t* clutData, const Rect& source, const Rect& blitRect, uint8_t alpha);
     *
     * @brief Blits a 2D indexed 8-bit source to the framebuffer.
     *
    ...
    /**
     * @fn static void LCD24bpp::blitCopyL8_RGB888(const uint8_t* sourceData, const uint8_t* clutData, const Rect& source, const Rect& blitRect, uint8_t alpha);
     *
     * @brief Blits a 2D indexed 8-bit source to the framebuffer.
     *
     *        Blits a 2D indexed 8-bit source to the framebuffer perfoming alpha-blending per pixel as
...
/**
 * @class LCD24DebugPrinter LCD24bpp.hpp platform/driver/lcd/LCD24bpp.hpp
 *
 * @brief The class LCD24DebugPrinter implements the DebugPrinter interface for printing debug messages on top of 24bit framebuffer.
 *
