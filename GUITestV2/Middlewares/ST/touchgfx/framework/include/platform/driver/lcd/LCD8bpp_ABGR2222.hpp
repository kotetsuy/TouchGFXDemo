...
/**
 * @class LCD8bpp_ABGR2222 LCD8bpp_ABGR2222.hpp platform/driver/lcd/LCD8bpp_ABGR2222.hpp
 *
...
public:
    ...
    virtual ~LCD8bpp_ABGR2222()
    {
    }

    /**
     * @fn virtual void LCD8bpp_ABGR2222::init();
     *
    ...
    /**
     * @fn virtual void LCD8bpp_ABGR2222::drawPartialBitmap(const Bitmap& bitmap, int16_t x, int16_t y, const Rect& rect, uint8_t alpha = 255, bool useOptimized = true);
     *
    ...
    /**
     * @fn virtual void LCD8bpp_ABGR2222::blitCopy(const uint16_t* sourceData, const Rect& source, const Rect& blitRect, uint8_t alpha, bool hasTransparentPixels);
     *
    ...
    /**
     * @fn virtual void LCD8bpp_ABGR2222::blitCopy(const uint8_t* sourceData, Bitmap::BitmapFormat sourceFormat, const Rect& source, const Rect& blitRect, uint8_t alpha, bool hasTransparentPixels);
     *
    ...
    /**
     * @fn virtual uint16_t* LCD8bpp_ABGR2222::copyFrameBufferRegionToMemory(const Rect& visRegion, const Rect& absRegion, const BitmapId bitmapId);
     *
    ...
    /**
     * @fn virtual void LCD8bpp_ABGR2222::fillRect(const Rect& rect, colortype color, uint8_t alpha = 255);
     *
    ...
    /**
     * @fn virtual uint8_t LCD8bpp_ABGR2222::bitDepth() const
     *
    ...
    /**
     * @fn virtual Bitmap::BitmapFormat LCD8bpp_ABGR2222::framebufferFormat() const
     *
    ...
    /**
     * @fn virtual uint16_t LCD8bpp_ABGR2222::framebufferStride() const
     *
    ...
    /**
     * @fn FORCE_INLINE_FUNCTION static uint16_t LCD8bpp_ABGR2222::getFramebufferStride()
     *
     * @brief Framebuffer stride in bytes
     *
     *        Framebuffer stride in bytes. The distance (in bytes) from the start of one
    ...
    /**
     * @fn virtual colortype LCD8bpp_ABGR2222::getColorFrom24BitRGB(uint8_t red, uint8_t green, uint8_t blue) const
     *
    ...
    /**
     * @fn FORCE_INLINE_FUNCTION static colortype LCD8bpp_ABGR2222::getColorFromRGB(uint8_t red, uint8_t green, uint8_t blue)
     *
    ...
    /**
     * @fn virtual uint8_t LCD8bpp_ABGR2222::getRedColor(colortype color) const
     *
    ...
    /**
     * @fn FORCE_INLINE_FUNCTION static uint8_t LCD8bpp_ABGR2222::getRedFromColor(colortype color)
     *
    ...
    /**
     * @fn virtual uint8_t LCD8bpp_ABGR2222::getGreenColor(colortype color) const
     *
    ...
    /**
     * @fn FORCE_INLINE_FUNCTION static uint8_t LCD8bpp_ABGR2222::getGreenFromColor(colortype color)
     *
    ...
    /**
     * @fn virtual uint8_t LCD8bpp_ABGR2222::getBlueColor(colortype color) const
     *
    ...
    /**
     * @fn FORCE_INLINE_FUNCTION static uint8_t LCD8bpp_ABGR2222::getBlueFromColor(colortype color)
     *
    ...
    /**
     * @fn void LCD8bpp_ABGR2222::enableTextureMapperAll();
     *
    ...
    /**
     * @fn void LCD8bpp_ABGR2222::enableTextureMapperABGR2222();
     *
     * @brief Enables the texture mappers for ABGR2222 image format.
     *
     *        Enables the texture mappers for ABGR2222 image format. This allows drawing
     *        ABGR2222 images using Bilinear Interpolation and Nearest Neighbor algorithms.
     *
     * @see enableTextureMapperABGR2222_BilinearInterpolation
     * @see enableTextureMapperABGR2222_NearestNeighbor
     */
    void enableTextureMapperABGR2222();

    /**
     * @fn void LCD8bpp_ABGR2222::enableTextureMapperABGR2222_BilinearInterpolation();
     *
     * @brief Enables the texture mappers for ABGR2222 image format for Bilinear Interpolation algorithm.
     *
     *        Enables the texture mappers for ABGR2222 image format. This allows drawing
     *        ABGR2222 images using Bilinear Interpolation algorithm.
     *
     * @see enableTextureMapperABGR2222
     * @see enableTextureMapperABGR2222_NearestNeighbor
     */
    void enableTextureMapperABGR2222_BilinearInterpolation();

    /**
     * @fn void LCD8bpp_ABGR2222::enableTextureMapperABGR2222_NearestNeighbor();
     *
     * @brief Enables the texture mappers for ABGR2222 image format for Nearest Neighbor algorithm.
     *
     *        Enables the texture mappers for ABGR2222 image format. This allows drawing
     *        ABGR2222 images using Nearest Neighbor algorithm.
     *
     * @see enableTextureMapperABGR2222
     * @see enableTextureMapperABGR2222_BilinearInterpolation
     */
    ...
    /**
     * @fn void LCD8bpp_ABGR2222::enableTextureMapperARGB8888();
     *
    ...
    /**
     * @fn void LCD8bpp_ABGR2222::enableTextureMapperARGB8888_BilinearInterpolation();
     *
    ...
    /**
     * @fn void LCD8bpp_ABGR2222::enableTextureMapperARGB8888_NearestNeighbor();
     *
    ...
    /**
     * @fn void LCD8bpp_ABGR2222::enableTextureMapperA4();
     *
    ...
    /**
     * @fn void LCD8bpp_ABGR2222::enableTextureMapperA4_BilinearInterpolation();
     *
    ...
    /**
     * @fn void LCD8bpp_ABGR2222::enableTextureMapperA4_NearestNeighbor();
     *
...
protected:
    ...
    /**
     * @fn static int LCD8bpp_ABGR2222::nextPixel(bool rotatedDisplay, TextRotation textRotation);
     *
    ...
    /**
     * @fn static int LCD8bpp_ABGR2222::nextLine(bool rotatedDisplay, TextRotation textRotation);
     *
    ...
    /**
     * @fn virtual void LCD8bpp_ABGR2222::drawGlyph(uint16_t* wbuf8, Rect widgetArea, int16_t x, int16_t y, uint16_t offsetX, uint16_t offsetY, const Rect& invalidatedArea, const GlyphNode* glyph, const uint8_t* glyphData, uint8_t dataFormatA4, colortype color, uint8_t bitsPerPixel, uint8_t alpha, TextRotation rotation);
     *
    ...
    /**
     * @fn static void LCD8bpp_ABGR2222::blitCopyARGB8888(const uint32_t* sourceData, const Rect& source, const Rect& blitRect, uint8_t alpha);
     *
    ...
    /**
     * @fn static void LCD8bpp_ABGR2222::blitCopyAlphaPerPixel(const uint16_t* sourceData16, const Rect& source, const Rect& blitRect, uint8_t alpha);
     *
     * @brief Blit a 2D source-array to the framebuffer.
     *
     *        Blit a 2D source-array to the framebuffer performing alpha-blending per pixel as
...
private:
    ...
    FORCE_INLINE_FUNCTION uint32_t convertABGR2222toARGB8888(uint8_t col) const
    {
...
/**
 * @class LCD8ABGR2222DebugPrinter LCD8bpp_ABGR2222.hpp platform/driver/lcd/LCD8bpp_ABGR2222.hpp
 *
 * @brief The class LCD8ABGR2222DebugPrinter implements the DebugPrinter interface for printing debug messages on top of 8bit framebuffer.
 *
