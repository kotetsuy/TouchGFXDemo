...
{
/**
 * @class PainterRGB565L8Bitmap PainterRGB565L8Bitmap.hpp touchgfx/widgets/canvas/PainterRGB565L8Bitmap.hpp
 *
 * @brief A Painter that will paint using a bitmap.
 *
 *        PainterRGB565L8Bitmap will take the color for a given point in the shape from a bitmap.
...
public:
    ...
    /**
     * @fn PainterRGB565L8Bitmap::PainterRGB565L8Bitmap(const Bitmap& bmp = Bitmap(BITMAP_INVALID), uint8_t alpha = 255);
     *
     * @brief Constructor.
     *
     *        Constructor.
    ...
    /**
     * @fn void PainterRGB565L8Bitmap::setBitmap(const Bitmap& bmp);
     *
    ...
    /**
     * @fn void PainterRGB565L8Bitmap::setAlpha(uint8_t alpha);
     *
    ...
    /**
     * @fn uint8_t PainterRGB565L8Bitmap::getAlpha() const;
     *
