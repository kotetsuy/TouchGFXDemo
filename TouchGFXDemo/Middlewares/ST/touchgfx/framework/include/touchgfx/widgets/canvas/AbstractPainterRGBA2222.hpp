...
{
/**
 * @class AbstractPainterRGBA2222 AbstractPainterRGBA2222.hpp touchgfx/widgets/canvas/AbstractPainterRGBA2222.hpp
 *
 * @brief A Painter that will paint using a color and an alpha value.
 *
 *        The AbstractPainterRGBA2222 class allows a shape to be filled with a given color and
...
public:
    ...
    virtual ~AbstractPainterRGBA2222() {}

    virtual void render(uint8_t* ptr, int x, int xAdjust, int y, unsigned count, const uint8_t* covers);

    /**
     * @fn FORCE_INLINE_FUNCTION uint8_t AbstractPainterRGBA2222::mixColors(uint8_t newpix, uint8_t bufpix, uint8_t alpha)
     *
     * @brief Mix colors.
     *
    ...
    /**
     * @fn FORCE_INLINE_FUNCTION uint8_t AbstractPainterRGBA2222::mixColors(uint8_t R, uint8_t G, uint8_t B, uint8_t bufpix, uint8_t alpha)
     *
     * @brief Mix colors.
     *
     *        Mix colors from a new pixel and a buffer pixel with the given alpha applied to the
    ...
    FORCE_INLINE_FUNCTION uint8_t mixColors(uint8_t R, uint8_t G, uint8_t B, uint8_t bufpix, uint8_t alpha)
    {
        ...
        return static_cast<uint8_t>(LCD8bpp_RGBA2222::getColorFromRGB(red, green, blue));
    }

protected:
    /**
     * @fn virtual bool AbstractPainterRGBA2222::renderInit()
     *
    ...
    /**
     * @fn virtual bool AbstractPainterRGBA2222::renderNext(uint8_t& red, uint8_t& green, uint8_t& blue, uint8_t& alpha) = 0;
     *
    ...
    /**
     * @fn virtual void AbstractPainterRGBA2222::renderPixel(uint8_t* p, uint8_t red, uint8_t green, uint8_t blue);
     *
