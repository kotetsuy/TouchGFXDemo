...
public:
    ...
    /**
     * @fn void LCD8bpp_ARGB2222::enableTextureMapperAll();
     *
    ...
    /**
     * @fn void LCD8bpp_ARGB2222::enableTextureMapperARGB2222();
     *
     * @brief Enables the texture mappers for ARGB2222 image format.
     *
     *        Enables the texture mappers for ARGB2222 image format. This allows drawing
     *        ARGB2222 images using Bilinear Interpolation and Nearest Neighbor algorithms.
     *
     * @see enableTextureMapperARGB2222_BilinearInterpolation
     * @see enableTextureMapperARGB2222_NearestNeighbor
     */
    void enableTextureMapperARGB2222();

    /**
     * @fn void LCD8bpp_ARGB2222::enableTextureMapperARGB2222_BilinearInterpolation();
     *
     * @brief Enables the texture mappers for ARGB2222 image format for Bilinear Interpolation algorithm.
     *
     *        Enables the texture mappers for ARGB2222 image format. This allows drawing
     *        ARGB2222 images using Bilinear Interpolation algorithm.
     *
     * @see enableTextureMapperARGB2222
     * @see enableTextureMapperARGB2222_NearestNeighbor
     */
    void enableTextureMapperARGB2222_BilinearInterpolation();

    /**
     * @fn void LCD8bpp_ARGB2222::enableTextureMapperARGB2222_NearestNeighbor();
     *
     * @brief Enables the texture mappers for ARGB2222 image format for Nearest Neighbor algorithm.
     *
     *        Enables the texture mappers for ARGB2222 image format. This allows drawing
     *        ARGB2222 images using Nearest Neighbor algorithm.
     *
     * @see enableTextureMapperARGB2222
     * @see enableTextureMapperARGB2222_BilinearInterpolation
     */
    ...
    /**
     * @fn void LCD8bpp_ARGB2222::enableTextureMapperARGB8888();
     *
    ...
    /**
     * @fn void LCD8bpp_ARGB2222::enableTextureMapperARGB8888_BilinearInterpolation();
     *
    ...
    /**
     * @fn void LCD8bpp_ARGB2222::enableTextureMapperARGB8888_NearestNeighbor();
     *
    ...
    /**
     * @fn void LCD8bpp_ARGB2222::enableTextureMapperA4();
     *
    ...
    /**
     * @fn void LCD8bpp_ARGB2222::enableTextureMapperA4_BilinearInterpolation();
     *
    ...
    /**
     * @fn void LCD8bpp_ARGB2222::enableTextureMapperA4_NearestNeighbor();
     *
...
/**
 * @class LCD8ARGB2222DebugPrinter LCD8bpp_ARGB2222.hpp platform/driver/lcd/LCD8bpp_ARGB2222.hpp
 *
 * @brief The class LCD8ARGB2222DebugPrinter implements the DebugPrinter interface for printing debug messages on top of 8bit framebuffer.
 *
