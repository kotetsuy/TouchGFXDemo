...
#ifndef PAINTERRGB888L8BITMAP_HPP
#define PAINTERRGB888L8BITMAP_HPP
...
{
/**
 * @class PainterRGB888L8Bitmap PainterRGB888L8Bitmap.hpp touchgfx/widgets/canvas/PainterRGB888L8Bitmap.hpp
 *
 * @brief A Painter that will paint using a bitmap.
 *
 *        PainterRGB888L8Bitmap will take the color for a given point in the shape from a bitmap.
 ...
 * @see AbstractPainter
 */
class PainterRGB888L8Bitmap : public AbstractPainterRGB888
{
public:

    /**
     * @fn PainterRGB888L8Bitmap::PainterRGB888L8Bitmap(const Bitmap& bmp = Bitmap(BITMAP_INVALID), uint8_t alpha = 255);
     *
     * @brief Constructor.
     *
     *        Constructor.
    ...
    /**
     * @fn void PainterRGB888L8Bitmap::setBitmap(const Bitmap& bmp);
     *
    ...
    /**
     * @fn void PainterRGB888L8Bitmap::setAlpha(uint8_t alpha);
     *
    ...
    /**
     * @fn uint8_t PainterRGB888L8Bitmap::getAlpha() const;
     *
