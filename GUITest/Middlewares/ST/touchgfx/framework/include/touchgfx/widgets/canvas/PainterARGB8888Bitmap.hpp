...
{
/**
 * @class PainterARGB8888Bitmap PainterARGB8888Bitmap.hpp touchgfx/widgets/canvas/PainterARGB8888Bitmap.hpp
 *
...
public:
    ...
    /**
     * @fn PainterARGB8888Bitmap::PainterARGB8888Bitmap(const Bitmap& bmp = Bitmap(BITMAP_INVALID), uint8_t alpha = 255);
     *
     * @brief Constructor.
     *
     *        Constructor.
    ...
    /**
     * @fn void PainterARGB8888Bitmap::setBitmap(const Bitmap& bmp);
     *
    ...
    /**
     * @fn void PainterARGB8888Bitmap::setAlpha(uint8_t alpha);
     *
    ...
    /**
     * @fn uint8_t PainterARGB8888Bitmap::getAlpha() const;
     *
